...
Main_frame.config(bg="#356696")
Main_frame.grid(row = 0 ,  column= 1 ,  padx= 96 ,  pady =  10)

# Text Lable 
Text_lable = Label(Main_frame, text = "I.R.I.S." , font=("Anta" ,  28 , "bold" ) , bg = "#356696")
...
text=Text(root , font= ('Anta') , bg = "#356696")
text.grid(row = 2,  column= 0)
text.place(x= 140, y= 320, width= 375, height= 100) 
